...
יומני עבודה, החלטות, ארכיטקטורה. קובץ אחד לנושא, כל סשן מוסיף entry בתחתית ה-Session Log עם status tag.

## Topics

- [[vault-initialization]] — אתחול ה-vault הזה: יצירת המבנה, תיעוד כל קובץ, וקביעת ש-`obsidian-vault-workflow` חובה בכל סשן
